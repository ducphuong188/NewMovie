...
import UIKit
protocol CollectionViewTableViewCellDelegate1: AnyObject {
    func collectionViewTableViewCellDidTapCell1(_ cell: TableViewCell, viewModel: TitlePreviewViewModel)
}
class TableViewCell: UITableViewCell {
    var models = [Title]()
  
    var delegate: CollectionViewTableViewCellDelegate1?
    static let identifier = "cell"
    private let collectionView: UICollectionView = {
        let layout = UICollectionViewFlowLayout()
        layout.itemSize = CGSize(width: 250, height: 140)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        Task {
            do {
                ...
                self.delegate?.collectionViewTableViewCellDidTapCell1(self, viewModel: TitlePreviewViewModel(title: titleName, youtubeView: videoElement, titleOverview: titleOverview))
            } catch {
